...
<div class="page-header">
    <div>
        ...
        <p class="admin-page-note">Ajusta rol, acceso y contraseña sin tocar permisos a mano.</p>
    </div>
</div>
...
<div class="card admin-form-card">
    ...
    <form method="post" action="/admin/users/edit?id=<?= (int) ($form['id'] ?? 0) ?>">
        ...
        <div class="form-group">
            ...
            <span class="field-note">Cambiar a agencia limita al usuario a crear/ver sus propias reservas. Cambiar a operador lo enfoca en su operacion asignada.</span>
        </div>
        ...
        <div id="agency_link_block" class="card" style="margin-bottom: 12px; background: #f8fafc; <?= $isAgencySelected ? '' : 'display:none;' ?>">
            ...
            <p class="admin-page-note">El usuario con rol agencia siempre debe estar ligado a una agencia/proveedor.</p>
